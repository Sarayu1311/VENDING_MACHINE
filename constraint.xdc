...
set_property -dict { PACKAGE_PIN M12    IOSTANDARD LVCMOS33 } [get_ports { reset  }];#LSB
...
## Switches
set_property -dict { PACKAGE_PIN L5    IOSTANDARD LVCMOS33 } [get_ports { sw1 }];#LSB
set_property -dict { PACKAGE_PIN L4    IOSTANDARD LVCMOS33 } [get_ports { sw2 }];
set_property -dict { PACKAGE_PIN M4    IOSTANDARD LVCMOS33 } [get_ports { sw3}];
...
## LEDs
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports {dispense }];#LSB
set_property -dict { PACKAGE_PIN H3    IOSTANDARD LVCMOS33 } [get_ports {change}];
...
### Push Button
set_property -dict {PACKAGE_PIN M12 IOSTANDARD LVCMOS33 } [get_ports {reset}];
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33 } [get_ports {coin_1}];
#set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS33 } [get_ports {pb[2]}];
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33 } [get_ports {coin_2}];
...
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {coin_1}];
#set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {pb[2]}];
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {coin_2}];
